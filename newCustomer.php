...
$(document).ready(function() {
	...
	$("#ushop").click(function() {
		ushopEnroll = true;
		console.log("SENDING TO USHOP API");
		var loginId = "api@cmssubscriptions";
		var password = "motivated2";
		var emailAddress = $("#customerEmail").val();
		var phoneNumber = $("#customerPhone").val();
		var firstName = $("#customerFname").val();
		var lastName = $("#customerLname").val();
		...
		var dataString = 'loginId='+loginId+'&password='+password
			+'&emailAddress='+emailAddress+'&phoneNumber='+phoneNumber+'&firstName='+firstName+'&lastName='+lastName+'&address1='+address1+'&address2='+address2
		...
		var url = "https://api2.konnektive.com/order/import?";
...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-3">
			<div id="agentdiv" class="form-group has-feedback">
				<label for="agentid">Rep Id</label>
				<input type="text" class="form-control" id="agentid" placeholder="" value="">
			</div>
		</div> <!--col-->
		<div class="col-sm-3">
			<div id="reciddiv" class="form-group has-feedback">
				<label for="recID">Recording Id</label>
				<input type="text" class="form-control" id="recID" value="">
			</div>
		</div> <!--col-->
		<div class="col-sm-3">
		</div> <!--col-->
...
<button id="ushop" type="button">ushop</button>
</body>
</html>
